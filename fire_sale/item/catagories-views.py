...
submenu.add_command(label="Shoes", command=noThing)
submenu.add_command(label="Clothes", command=noThing)
submenu.add_command(label="Accessories", command=noThing)
submenu.add_command(label="Books", command=noThing)
submenu.add_command(label="Toys And Games", command=noThing)
